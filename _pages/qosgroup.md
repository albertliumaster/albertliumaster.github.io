...
<p align="justify">
![]({{ site.url }}{{ site.baseurl }}/images/respic/QOSGroup_1.png){: style="width: 320px; float: left; margin: 0px 10px"}
...
<p align="justify">
![]({{ site.url }}{{ site.baseurl }}/images/respic/QOSGroup_2.png){: style="width: 200px; float: right; margin: 0px  10px"}
